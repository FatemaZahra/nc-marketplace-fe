...
const NewItem = ({setCurrentItem}) => {
    const [addedItem, setAddedItem] = useState({item_name: '', img_url: '', price: 0, description: '', category_name: ''});

    const handleSubmit = (event) => {
        event.preventDefault();
        postItem(addedItem).then(() => {
        ...
        setAddedItem({item_name: '', img_url: '', price: 0, description: '', category_name: ''});
      };
